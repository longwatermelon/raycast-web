...
struct Prog *prog_init(SDL_Window *window, SDL_Renderer *rend)
{
    ...
    self->font = TTF_OpenFont("assets/images/font.ttf", 16);
    ...
    self->map = map_init("assets/map", (SDL_Point){ 32, 32 }, 50);
    ...
    self->tile_texture = IMG_LoadTexture(self->rend, "assets/images/wall.png");
    ...
    self->crosshair_texture = IMG_LoadTexture(self->rend, "assets/images/crosshair.png");
    ...
    /* while (self->running) */
    {
        ...
        if (!self->game_over)
        {
            ...
            if (rand() % 2000 > 1930 && self->entities_size < MAX_ENTITIES)
                prog_spawn_entity(self, ENTITY_ENEMY, "assets/images/shrek.png");

            if (rand() % 2000 > 1990 && self->entities_size < MAX_ENTITIES)
                prog_spawn_entity(self, ENTITY_AMMO, "assets/images/ammo.png");
            ...
            if (!nuts_exist)
                prog_spawn_entity(self, ENTITY_NUTS, "assets/images/deez.png");
        }
